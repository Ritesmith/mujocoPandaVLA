...
$PYTHON -m models.train_csil_plus_plus train-reward \
    --n_epochs 100 \
    --batch_size 256 \
    --learning_rate 1e-3 \
...
$PYTHON -m models.train_csil_plus_plus verify 2>&1 | tee outputs/csil_plus_plus/verify_log.txt

# Step 3: PBRS fine-tune a_pi (conservative)
echo ""
echo "=== Step 3: PBRS fine-tune a_pi (20 iterations, ~10k steps) ==="
$PYTHON -m models.train_csil_plus_plus train-ensemble \
    --max_iterations 20 \
